          ...
          <div className="about-grid">
            <motion.div variants={itemVariants} className="about-image-container">
              <div className="about-image-wrapper glass">
                <img src="/profile.png" alt="Balamurugan M" className="about-img" />
              </div>
            </motion.div>
            ...
            <div className="about-text-section">
              <div className="about-text-container">
                <motion.p variants={itemVariants} className="about-text">
                  I am a motivated and responsible individual with a strong interest in learning new skills and applying them effectively in real-world environments.
                </motion.p>
                <motion.p variants={itemVariants} className="about-text">
                  As a dedicated team player with a positive attitude, I strive to build innovative solutions that solve real problems.
                </motion.p>
              </div>
